...
$translations = [
    ...
    // ---------- Theme ----------
    'topbar.theme'           => ['en' => 'Dark / light mode', 'nl' => 'Donkere / lichte modus', 'ar' => 'الوضع الداكن / الفاتح'],

    // ---------- Family window v2: year table + month totals ----------
    'family.year'            => ['en' => 'Year', 'nl' => 'Jaar', 'ar' => 'السنة'],
    'family.month'           => ['en' => 'Month', 'nl' => 'Maand', 'ar' => 'الشهر'],
    'family.col_student'     => ['en' => 'Student', 'nl' => 'Leerling', 'ar' => 'الطالب'],
    'family.col_year_paid'   => ['en' => 'Paid :year', 'nl' => 'Betaald :year', 'ar' => 'مدفوع :year'],
    'family.col_balance'     => ['en' => 'Owed', 'nl' => 'Openstaand', 'ar' => 'المتبقي'],
    'family.paid_now'        => ['en' => 'recorded :amount €', 'nl' => 'geregistreerd :amount €', 'ar' => 'المسجَّل :amount €'],
    'family.fill_due'        => ['en' => 'Full', 'nl' => 'Volledig', 'ar' => 'كامل'],
    'family.fill_due_title'  => ['en' => 'Fill in the full amount due', 'nl' => 'Volledig verschuldigd bedrag invullen', 'ar' => 'املأ المبلغ المستحق كاملاً'],
    'family.form_hint'       => ['en' => 'Each amount is the child\'s total for this month — raise it to add, lower or clear it to reduce.', 'nl' => 'Elk bedrag is het totaal van het kind voor deze maand — verhoog om toe te voegen, verlaag of wis om te verminderen.', 'ar' => 'كل مبلغ هو مجموع الطفل لهذا الشهر — زِده للإضافة، أو أنقصه أو امسحه للتخفيض.'],
    'family.no_changes'      => ['en' => 'No changes', 'nl' => 'Geen wijzigingen', 'ar' => 'لا توجد تغييرات'],
    'family.confirm_reduce'  => ['en' => 'This lowers or removes recorded payments:', 'nl' => 'Hiermee worden geregistreerde betalingen verlaagd of verwijderd:', 'ar' => 'سيتم إنقاص أو حذف مبالغ مسجّلة:'],
    'family.saved_changes'   => ['en' => 'Saved — added :added € · reduced :removed €', 'nl' => 'Opgeslagen — toegevoegd :added € · verlaagd :removed €', 'ar' => 'تم الحفظ — أُضيف :added € · خُصم :removed €'],

    // ---------- Add / edit student ----------
    'student.add'            => ['en' => '➕ Add student', 'nl' => '➕ Leerling toevoegen', 'ar' => '➕ إضافة طالب'],
    'student.add_title'      => ['en' => 'Add a new student', 'nl' => 'Nieuwe leerling toevoegen', 'ar' => 'إضافة طالب جديد'],
    'student.edit'           => ['en' => '✏️ Edit student details', 'nl' => '✏️ Leerlinggegevens wijzigen', 'ar' => '✏️ تعديل بيانات الطالب'],
    'student.edit_title'     => ['en' => 'Edit student details', 'nl' => 'Leerlinggegevens wijzigen', 'ar' => 'تعديل بيانات الطالب'],
    'student.add_sibling'    => ['en' => '➕ Add a child to this family', 'nl' => '➕ Kind aan dit gezin toevoegen', 'ar' => '➕ إضافة طفل لهذه العائلة'],
    'student.external_id'    => ['en' => 'Student number', 'nl' => 'Leerlingnummer', 'ar' => 'رقم الطالب'],
    'student.external_id_help' => ['en' => 'Its number in the Excel sheet — the next free number is suggested.', 'nl' => 'Het nummer in het Excel-bestand — het volgende vrije nummer wordt voorgesteld.', 'ar' => 'رقمه في ملف Excel — يُقترح أول رقم متاح تلقائياً.'],
    'student.fee_help'       => ['en' => 'Leave empty for the default fee (:fee €).', 'nl' => 'Leeg laten voor het standaardbedrag (:fee €).', 'ar' => 'اتركه فارغاً لاستخدام الرسم الافتراضي (:fee €).'],
    'student.allow_sms'      => ['en' => 'Receives reminder messages', 'nl' => 'Ontvangt herinneringsberichten', 'ar' => 'يستقبل رسائل التذكير'],
    'student.family_join'    => ['en' => 'Joins the family: :name (:count children)', 'nl' => 'Wordt gekoppeld aan gezin: :name (:count kinderen)', 'ar' => 'سيُضمّ إلى عائلة: :name (:count أطفال)'],
    'student.family_new'     => ['en' => 'New number — a new family will be created', 'nl' => 'Nieuw nummer — er wordt een nieuw gezin aangemaakt', 'ar' => 'رقم جديد — ستُنشأ عائلة جديدة'],
    'student.family_none'    => ['en' => 'No phone number — not linked to a family', 'nl' => 'Geen telefoonnummer — niet aan een gezin gekoppeld', 'ar' => 'بدون رقم هاتف — لن يُربط بعائلة'],
    'student.phone_invalid'  => ['en' => 'Invalid phone number', 'nl' => 'Ongeldig telefoonnummer', 'ar' => 'رقم الهاتف غير صالح'],
    'student.created'        => ['en' => 'Student :name added', 'nl' => 'Leerling :name toegevoegd', 'ar' => 'تمت إضافة الطالب :name'],
    'student.updated'        => ['en' => ':name saved', 'nl' => ':name opgeslagen', 'ar' => 'تم حفظ بيانات :name'],

    // ---------- Enrolment month from the UI ----------
    'enroll.label'           => ['en' => 'Enrolled', 'nl' => 'Ingeschreven', 'ar' => 'الالتحاق'],
    'enroll.not_set'         => ['en' => 'not set', 'nl' => 'niet ingesteld', 'ar' => 'غير محدد'],
    'enroll.since'           => ['en' => 'since :month', 'nl' => 'sinds :month', 'ar' => 'منذ :month'],
    'enroll.set_btn'         => ['en' => '📅 Make :month the enrolment month', 'nl' => '📅 :month als inschrijfmaand instellen', 'ar' => '📅 تعيين :month كشهر الالتحاق'],
    'enroll.start_here'      => ['en' => 'Starts this month', 'nl' => 'Start deze maand', 'ar' => 'يبدأ من هذا الشهر'],
    'enroll.is_this'         => ['en' => 'Enrolment month', 'nl' => 'Inschrijfmaand', 'ar' => 'شهر الالتحاق'],
    'enroll.clear_btn'       => ['en' => 'Clear enrolment date', 'nl' => 'Inschrijfdatum wissen', 'ar' => 'إلغاء تاريخ الالتحاق'],
    'enroll.clear_confirm'   => ['en' => 'Clear the enrolment date? Every month of the year will count again.', 'nl' => 'Inschrijfdatum wissen? Alle maanden tellen dan weer mee.', 'ar' => 'إلغاء تاريخ الالتحاق؟ ستُحتسب كل الأشهر مجدداً.'],
    'enroll.confirm'         => ['en' => 'The student will count as enrolled from :month; earlier months will no longer be owed.', 'nl' => 'De leerling telt als ingeschreven vanaf :month; eerdere maanden zijn niet meer verschuldigd.', 'ar' => 'سيُعتبر الطالب ملتحقاً من :month، ولن تُحتسب عليه الأشهر التي قبله.'],
    'enroll.confirm_payments' => ['en' => ':count payments recorded before this month are kept.', 'nl' => ':count betalingen van vóór deze maand blijven bewaard.', 'ar' => 'يوجد :count دفعات مسجّلة قبل هذا الشهر وستبقى محفوظة.'],
    'enroll.saved'           => ['en' => 'Enrolled from :month', 'nl' => 'Ingeschreven vanaf :month', 'ar' => 'تم تعيين الالتحاق من :month'],
    'enroll.cleared'         => ['en' => 'Enrolment date cleared', 'nl' => 'Inschrijfdatum gewist', 'ar' => 'أُلغي تاريخ الالتحاق'],
    'enroll.after_withdrawal' => ['en' => 'Not possible: the withdrawal date is before this month.', 'nl' => 'Niet mogelijk: de uitschrijfdatum ligt vóór deze maand.', 'ar' => 'غير ممكن: تاريخ الانسحاب قبل هذا الشهر.'],
    'enroll.before_hint'     => ['en' => 'Before enrolment — not owed', 'nl' => 'Vóór inschrijving — niet verschuldigd', 'ar' => 'قبل الالتحاق — غير مستحق'],

    // ---------- Templates: Dutch + Arabic translation, English placeholders ----------
    'templates.body_nl'      => ['en' => 'Dutch text (sent)', 'nl' => 'Nederlandse tekst (wordt verzonden)', 'ar' => 'النص الهولندي (يُرسل)'],
    'templates.body_ar'      => ['en' => 'Arabic translation', 'nl' => 'Arabische vertaling', 'ar' => 'الترجمة العربية'],
    'templates.send_translation' => ['en' => 'Send the Arabic translation under the Dutch text', 'nl' => 'Arabische vertaling onder de Nederlandse tekst meesturen', 'ar' => 'إرسال الترجمة العربية تحت النص الهولندي'],
    'templates.send_translation_hint' => ['en' => 'A message containing Arabic is sent as Unicode (70 characters per SMS instead of 160), so it costs several SMS.', 'nl' => 'Een bericht met Arabisch wordt als Unicode verzonden (70 tekens per sms i.p.v. 160) en kost dus meerdere sms\'jes.', 'ar' => 'الرسالة التي تحتوي عربياً تُرسل بترميز Unicode (‏70 حرفاً للرسالة بدل 160)، فتُحتسب عدة رسائل.'],
    'templates.badge_manual' => ['en' => '✍️ Manual', 'nl' => '✍️ Handmatig', 'ar' => '✍️ يدوي'],
    'templates.badge_translation' => ['en' => '🌐 + Arabic', 'nl' => '🌐 + Arabisch', 'ar' => '🌐 مع الترجمة'],
    'templates.manual_section' => ['en' => '✍️ Manual message history', 'nl' => '✍️ Geschiedenis handmatige berichten', 'ar' => '✍️ سجل القوالب اليدوية'],
    'templates.preview_title' => ['en' => 'The message as it will be sent', 'nl' => 'Het bericht zoals het verzonden wordt', 'ar' => 'الرسالة كما ستُرسل'],
    'templates.preview_for'  => ['en' => 'Example for :name — :month', 'nl' => 'Voorbeeld voor :name — :month', 'ar' => 'مثال لـ :name — :month'],
    'templates.cost_per_message' => ['en' => 'About :cost € per message', 'nl' => 'Ongeveer :cost € per bericht', 'ar' => 'حوالي :cost € لكل رسالة'],
    'tplvar.title'           => ['en' => 'Variables (click to insert)', 'nl' => 'Variabelen (klik om in te voegen)', 'ar' => 'المتغيرات (اضغط للإدراج)'],
    'tplvar.family_group'    => ['en' => 'Family', 'nl' => 'Gezin', 'ar' => 'للعائلة'],
    'tplvar.unknown'         => ['en' => 'Unknown variables: :vars', 'nl' => 'Onbekende variabelen: :vars', 'ar' => 'متغيرات غير معروفة: :vars'],
    'tplvar.student_name'    => ['en' => 'Student name (siblings\' names when sent per family)', 'nl' => 'Naam leerling (namen van broers/zussen per gezin)', 'ar' => 'اسم الطالب (أسماء الإخوة عند الإرسال للعائلة)'],
    'tplvar.month_nl'        => ['en' => 'Month name in Dutch', 'nl' => 'Maandnaam in het Nederlands', 'ar' => 'اسم الشهر بالهولندية'],
    'tplvar.month_ar'        => ['en' => 'Month name in Arabic', 'nl' => 'Maandnaam in het Arabisch', 'ar' => 'اسم الشهر بالعربية'],
    'tplvar.month_en'        => ['en' => 'Month name in English', 'nl' => 'Maandnaam in het Engels', 'ar' => 'اسم الشهر بالإنجليزية'],
    'tplvar.year'            => ['en' => 'Year', 'nl' => 'Jaar', 'ar' => 'السنة'],
    'tplvar.due'             => ['en' => 'Amount due for the month', 'nl' => 'Verschuldigd bedrag voor de maand', 'ar' => 'المستحق للشهر'],
    'tplvar.paid'            => ['en' => 'Amount paid for the month', 'nl' => 'Betaald bedrag voor de maand', 'ar' => 'المدفوع للشهر'],
    'tplvar.balance'         => ['en' => 'Still owed for the month', 'nl' => 'Nog te betalen voor de maand', 'ar' => 'المتبقي للشهر'],
    'tplvar.children_names'  => ['en' => 'Names of all the children', 'nl' => 'Namen van alle kinderen', 'ar' => 'أسماء الأبناء'],
    'tplvar.unpaid_names'    => ['en' => 'Names of the children who have not paid', 'nl' => 'Namen van kinderen die nog niet betaald hebben', 'ar' => 'أسماء غير المدفوعين'],
    'tplvar.children_count'  => ['en' => 'Number of children', 'nl' => 'Aantal kinderen', 'ar' => 'عدد الأبناء'],
    'tplvar.family_total'    => ['en' => 'Family total due', 'nl' => 'Totaal verschuldigd gezin', 'ar' => 'مجموع مستحق العائلة'],
    'tplvar.family_paid'     => ['en' => 'Family total paid', 'nl' => 'Totaal betaald gezin', 'ar' => 'مجموع مدفوع العائلة'],
    'tplvar.family_balance'  => ['en' => 'Family still owes', 'nl' => 'Gezin nog te betalen', 'ar' => 'متبقي العائلة'],
    'tplvar.children_details' => ['en' => 'One line per child with its amount', 'nl' => 'Eén regel per kind met bedrag', 'ar' => 'سطر لكل ابن مع مبلغه'],
    'send.manual_template'   => ['en' => '✍️ Manual message (saved to the history)', 'nl' => '✍️ Handmatig bericht (wordt bewaard in de geschiedenis)', 'ar' => '✍️ قالب يدوي (يُحفظ تلقائياً في السجل)'],
    'send.library_templates' => ['en' => 'Templates', 'nl' => 'Sjablonen', 'ar' => 'القوالب'],
    'send.manual_history'    => ['en' => 'Manual message history', 'nl' => 'Geschiedenis handmatige berichten', 'ar' => 'سجل القوالب اليدوية'],
    'send.manual_help'       => ['en' => 'The text is sent exactly as written and kept in the template history when you send.', 'nl' => 'De tekst wordt precies zo verzonden en bij verzenden bewaard in de sjabloongeschiedenis.', 'ar' => 'يُرسل النص كما كتبته، ويُحفظ تلقائياً في سجل القوالب عند الإرسال.'],
    'send.manual_saved'      => ['en' => 'Saved to the template history', 'nl' => 'Bewaard in de sjabloongeschiedenis', 'ar' => 'حُفظ النص في سجل القوالب'],
    'send.preview_live'      => ['en' => 'Updates automatically', 'nl' => 'Wordt automatisch bijgewerkt', 'ar' => 'تُحدَّث تلقائياً'],
    'send.preview_updating'  => ['en' => 'Updating…', 'nl' => 'Bijwerken…', 'ar' => 'جارٍ التحديث…'],
